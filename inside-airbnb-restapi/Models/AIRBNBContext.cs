...
namespace WebApplication1.Models
{
    public partial class AIRBNBContext : DbContext
    {
        ...
        public virtual DbSet<Listings2019> Listings2019s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost;Database=AIRBNB;User Id=sa;password=MSSQL_server;Trusted_Connection=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Listing>(entity =>
            {
                ...
                entity.Property(e => e.Availability30)
                    .IsUnicode(false)
                    .HasColumnName("availability_30");

                entity.Property(e => e.Availability365)
                    .IsUnicode(false)
                    .HasColumnName("availability_365");

                entity.Property(e => e.Availability60)
                    .IsUnicode(false)
                    .HasColumnName("availability_60");

                entity.Property(e => e.Availability90)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.CalculatedHostListingsCount)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.MaximumMaximumNights)
                    .IsUnicode(false)
                    .HasColumnName("maximum_maximum_nights");

                entity.Property(e => e.MaximumMinimumNights)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.MinimumMaximumNights)
                    .IsUnicode(false)
                    .HasColumnName("minimum_maximum_nights");

                entity.Property(e => e.MinimumMinimumNights)
                    .IsUnicode(false)
                ...
                entity.Property(e => e.NumberOfReviewsL30d)
                    .IsUnicode(false)
                    .HasColumnName("number_of_reviews_l30d");

                entity.Property(e => e.NumberOfReviewsLtm)
                    .IsUnicode(false)
            ...
            modelBuilder.Entity<Listings2019>(entity =>
            {
                entity.ToTable("listings2019");
